...
public class QuestNavUtils {
    ...
    // Zero the absolute 3D position of the quest (similar to long-pressing the
    // quest logo)
    ...
    public Rotation2d getUncorrectedYaw() {
        float[] eulerAngles = questEulerAngles.get();
